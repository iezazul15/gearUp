...
const createPaymentIntent = async (userId: string, rentalOrderId: string) => {
  ...
  const data: SSLCommerzPayment = {
    ...
    currency: "BDT",
    tran_id: `${trnx_id}`,
    success_url: `https://gearup-mu-ten.vercel.app/api/payments/callback?tran_id=${trnx_id}&order_id=${rentalOrder.id}&status=success`,
    fail_url: `https://gearup-mu-ten.vercel.app/api/payments/callback?tran_id=${trnx_id}&order_id=${rentalOrder.id}&status=fail`,
    cancel_url: `https://gearup-mu-ten.vercel.app/api/payments/callback?tran_id=${trnx_id}&order_id=${rentalOrder.id}&status=cancel`,
